...
public class NickNameActivity extends Activity {
	...
	private void createDialog() {
		final View innerView = getLayoutInflater().inflate(R.layout.nickname, null);
		...
		mDialog.setOnCancelListener(new OnCancelListener() {
			...
			public void onCancel(DialogInterface dialog) {
				Toast.makeText(NickNameActivity.this, "cancle listener", Toast.LENGTH_SHORT).show();
			}
		});
		...
		mDialog.setOnShowListener(new OnShowListener() {
			...
			public void onShow(DialogInterface dialog) {
				Toast.makeText(NickNameActivity.this, "show listener", Toast.LENGTH_SHORT).show();
			}
		});
		...
		mDialog.setOnDismissListener(new OnDismissListener() {
			...
			public void onDismiss(DialogInterface dialog) {
				Toast.makeText(NickNameActivity.this, "dismiss listener", Toast.LENGTH_SHORT).show();
			}
		});
